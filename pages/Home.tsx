...
/**
 * FIXED IMAGE PATH:
 * In React projects, files inside the 'public' folder are accessed using a simple forward slash.
 * DO NOT use "public\founder.jpg" or backslashes.
 */
...
const Home: React.FC = () => {
  // FIXED: Properly typed refs to avoid TypeScript 'null' errors
  ...
  return (
    ...
    >
          ...
          <div className="order-1 lg:order-2 relative flex justify-center lg:justify-end w-full">
            ...
            >
              ...
              <div className="relative w-full h-full rounded-[60px] md:rounded-[100px] bg-white/40 backdrop-blur-3xl border border-white/50 shadow-glass overflow-hidden z-10 transition-transform duration-700 group-hover:scale-[1.01] will-change-transform">
                ...
                {/* FOUNDER IMAGE: Ensure object-cover is used to fill the container correctly */}
                <motion.img 
                  style={{ y: heroImageY }}
                  src={FOUNDER_IMAGE} 
                  alt="Dr. Harish Kamaraj" 
                  className="w-full h-[120%] object-cover object-top select-none pointer-events-none drop-shadow-[0_40px_80px_rgba(0,0,0,0.18)] transform-gpu will-change-transform"
                />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
            ...
            <div className="lg:col-span-7 relative order-2 lg:order-1">
              ...
              >
                ...
                <img src={FOUNDER_IMAGE} 
                      alt="Dr. Harish Kamaraj Vision" 
                      className="w-full h-full object-cover object-top filter grayscale group-hover:grayscale-0 transition-all duration-1000 scale-[1.02] group-hover:scale-[1.06]"
                    />
      ...
      {/* Ventures Section Cards - Fixed URLs */}
      <section id="ventures" className="py-32 lg:py-52 px-6 bg-notion-cream/30 scroll-mt-24 border-t border-notion-border overflow-hidden">
        <div className="max-w-[1300px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-12">
            <div className="max-w-3xl text-center md:text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-20">
            {/* Card 1: Project S */}
            <div className="group block h-full">
              <motion.div className="rounded-[72px] overflow-hidden border border-white/5 bg-brand-navy shadow-4xl h-full flex flex-col">
                <div className="aspect-[16/10] bg-brand-sapphire/20 relative overflow-hidden shrink-0 border-b border-white/5">
                  <div className="absolute inset-0 bg-cover bg-center opacity-40 grayscale group-hover:grayscale-0 transition-all duration-1000" style={{ backgroundImage: `url('${ASSET_PROJECT_S_GOVERNANCE}')` }}></div>
                </div>
                <div className="p-16 flex flex-col flex-grow text-white">
                  <h3 className="text-4xl lg:text-5xl font-bold mb-4 tracking-tight">Project S</h3>
                  <p className="text-brand-gold font-bold tracking-[0.4em] uppercase text-[10px] mb-8">Under Development</p>
                  <p className="text-slate-400 text-xl font-light leading-relaxed flex-grow">
                    The parent governance institution designed to anchor all industrial ventures.
                  </p>
                </div>
              </motion.div>
            </div>

            {/* Card 2: Medinet Pharmaceutical */}
            <div className="group block h-full">
              <motion.div className="rounded-[72px] overflow-hidden border border-white/5 bg-brand-navy shadow-4xl h-full flex flex-col">
                <div className="aspect-[16/10] bg-brand-sapphire/20 relative overflow-hidden shrink-0 border-b border-white/5">
                  <div className="absolute inset-0 bg-cover bg-center opacity-40 grayscale group-hover:grayscale-0 transition-all duration-1000" style={{ backgroundImage: `url('${ASSET_MEDINET_CLINICAL}')` }}></div>
                </div>
                <div className="p-16 flex flex-col flex-grow text-white">
                  <h3 className="text-4xl lg:text-5xl font-bold mb-8 tracking-tight">Medinet Pharmaceutical</h3>
                  <div className="space-y-6 flex-grow">
                    <div className="flex items-center gap-4 text-slate-300 text-xl font-light opacity-80">
                      <span className="w-1.5 h-1.5 rounded-full bg-slate-500"></span> Medinet Pharmacy
                    </div>
                    <div className="flex items-center gap-4">
                      <span className="w-1.5 h-1.5 rounded-full bg-brand-gold"></span>
                      <Link to="/" className="text-white text-xl hover:text-brand-gold transition-colors">Medinet Pharma</Link>
                    </div>
                  </div>
                </div>
              </motion.div>
